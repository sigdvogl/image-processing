...
cp 250x250/$i /Volumes/Bilddaten/Konf/$i
mv 250x250/$i /Volumes/Bilddaten/master/Konf_250x250/$i
##mv 250x250_Branding/$i /Volumes/Bilddaten/master/Spw_250x250_branding/$i
mv 300dpi/$i /Volumes/Bilddaten/master/Konf_300dpi/$i
...
mv 2000x2000/$i /Volumes/Bilddaten/master/Konf_2000x2000/$i
done
